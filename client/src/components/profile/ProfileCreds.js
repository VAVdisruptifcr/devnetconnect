  ...
  render() {
    ...
    const eduItems = education.map(edu => (
      <li key={edu._id} className="list-group-item">
        ...
        <p>
          <strong>Área de estudio: </strong> {edu.fieldofstudy}{" "}
        </p>
        <p>
      ...
      <div className="row">
        <div className="col-md-6">
          ...
          {expItems.length > 0 ? (
            ...
            <p className="text-center">No hay experiencia que mostrar</p>
          )}
        </div>
        ...
        <div className="col-md-6">
          ...
          {eduItems.length > 0 ? (
            ...
            <p className="text-center">No hay educación que mostrar</p>
          )}
        </div>
      </div>
    );

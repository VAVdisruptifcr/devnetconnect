          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">
                Ingresa tu información para que tu perfil se destaque{" "}
              </p>
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="If you want show your latest repos and a GitHub link, include your username"
                />
                <TextAreaFieldGroup
                ...
                <div className="mb-3">
                  ...
                  <span className="text-muted">Just optional</span>
                </div>
                {socialInputs}
                <input
                  type="submit"
